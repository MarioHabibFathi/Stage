...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 24 18:42:32 2023
...
class FCN:
    ...
    def build_model(self):
        ...
        # print(self.input_shape)
        #f 128 256 128 k 8 5 3 
        #f 32 64 32 k 40 20 10 
        # Add encoder layers
        self.conv1 = tf.keras.layers.Conv1D(filters=32, kernel_size=40, padding='same')(self.reshape_layer)
        self.bn1 = tf.keras.layers.BatchNormalization()(self.conv1)
        self.relu1 = tf.keras.layers.Activation(activation='relu')(self.bn1)

        self.conv2 = tf.keras.layers.Conv1D(filters=64, kernel_size=20, padding='same')(self.relu1)
        self.bn2 = tf.keras.layers.BatchNormalization()(self.conv2)
        self.relu2 = tf.keras.layers.Activation(activation='relu')(self.bn2)

        self.conv3 = tf.keras.layers.Conv1D(filters=32, kernel_size=10, padding='same')(self.relu2)
        ...
        # self.conv4 = tf.keras.layers.Conv1D(filters=1, kernel_size=1, padding='same')(self.relu3)
        # self.bn4 = tf.keras.layers.BatchNormalization()(self.conv4)
        # self.relu4 = tf.keras.layers.Activation(activation='relu')(self.bn4)
        ...
        self.conv_transpose4 = tf.keras.layers.Conv1DTranspose(filters=32, kernel_size=10, padding='same')(self.relu3)
        ...
        self.conv_transpose5 = tf.keras.layers.Conv1DTranspose(filters=64, kernel_size=20, padding='same')(self.relu_transpose4)
        ...
        self.conv_transpose6 = tf.keras.layers.Conv1DTranspose(filters=32, kernel_size=40, padding='same')(self.relu_transpose5)
        ...
        self.output_layer = tf.keras.layers.Reshape((-1,))(self.conv_transpose7)
